            ...
            <div className="max-w-md w-full space-y-8 bg-white p-8 sm:p-10 rounded-3xl shadow-xl border border-brand-peach/20">
                <div className="text-center">
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                        Join Romashka Health Care for better health management
                    </p>
                </div>
                ...
                <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
                    <div className="space-y-4">
                        <div>
                            <label className="text-sm font-semibold text-gray-700 ml-1 mb-1 block">Full Name</label>
                        ...
                        <div>
                            <label className="text-sm font-semibold text-gray-700 ml-1 mb-1 block">Phone Number</label>
                            <div className="relative">
                    ...
                    <div className="text-center pt-2">
                        <Link to="/login" className="text-brand-blue font-semibold hover:text-blue-700 transition-colors">
