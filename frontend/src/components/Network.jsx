        ...
        <section className="py-20 bg-white">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    <h2 className="text-4xl font-bold text-brand-dark mb-4">Our Extensive Network</h2>
                    <p className="text-gray-500 max-w-2xl mx-auto">Providing accessible world-class eye care across major metropolitan areas.</p>
                </div>
                ...
                <div className="mt-12 p-8 bg-brand-cream rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6 border border-brand-peach/20">
                    <div>
                        <h3 className="text-xl font-bold text-brand-dark mb-2">Can't find a center near you?</h3>
                        <p className="text-gray-500 text-sm">We are rapidly expanding. Check our full list of 50+ satellite clinics.</p>
                    </div>
